...
namespace GLib {
	...
	public class Socket : GLib.Object, GLib.DatagramBased, GLib.Initable {
		...
		public ssize_t receive_message (out GLib.SocketAddress? address, [CCode (array_length_cname = "num_vectors", array_length_pos = 2.5)] GLib.InputVector[] vectors, [CCode (array_length_cname = "num_messages", array_length_pos = 3.5)] out GLib.SocketControlMessage[]? messages, ref GLib.SocketMsgFlags flags, GLib.Cancellable? cancellable = null) throws GLib.Error;
		[Version (since = "2.48")]
