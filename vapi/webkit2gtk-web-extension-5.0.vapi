/* webkit2gtk-web-extension-5.0.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "WebKit", gir_namespace = "WebKit2WebExtension", gir_version = "5.0", lower_case_cprefix = "webkit_")]
namespace WebKit {
	namespace DOM {
