	...
	namespace PbUtils {
		namespace Codec {
			...
			namespace H264 {
				...
				[Version (since = "1.20")]
				public static bool get_profile_flags_level ([CCode (array_length_cname = "len", array_length_pos = 1.5)] uint8[:uint] codec_data, out uint8 profile, out uint8 flags, out uint8 level);
			}
