...
namespace Gst {
	...
	namespace RTP {
		...
		public abstract class HeaderExtension : Gst.Element {
			...
			public virtual bool read (Gst.RTP.HeaderExtensionFlags read_flags, [CCode (array_length_cname = "size", array_length_pos = 2.5, type = "const guint8*")] uint8[:size_t] data, Gst.Buffer buffer);
			...
			public virtual size_t write (Gst.Buffer input_meta, Gst.RTP.HeaderExtensionFlags write_flags, Gst.Buffer output, [CCode (array_length_cname = "size", array_length_pos = 4.1, type = "guint8*")] uint8[:size_t] data);
		}
		[CCode (cheader_filename = "gst/rtp/rtp.h", has_type_id = false)]
		[GIR (name = "RTPBuffer")]
		public struct Buffer {
