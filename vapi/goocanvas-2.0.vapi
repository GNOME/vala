...
namespace Goo {
	[CCode (cheader_filename = "GooCanvas-2.0.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "goo_cairo_matrix_get_type ()")]
	[Compact]
	public class CairoMatrix {
		public static Cairo.Matrix? copy (Cairo.Matrix matrix);
		public static void free (Cairo.Matrix matrix);
	}
	[CCode (cheader_filename = "GooCanvas-2.0.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "goo_cairo_pattern_get_type ()")]
	[Compact]
	...
	[CCode (cheader_filename = "GooCanvas-2.0.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "goo_canvas_bounds_get_type ()")]
	[Compact]
	...
	[CCode (cheader_filename = "GooCanvas-2.0.h", ref_function = "goo_canvas_line_dash_ref", type_id = "goo_canvas_line_dash_get_type ()", unref_function = "goo_canvas_line_dash_unref")]
	[Compact]
	...
	[CCode (cheader_filename = "GooCanvas-2.0.h", ref_function = "goo_canvas_points_ref", type_id = "goo_canvas_points_get_type ()", unref_function = "goo_canvas_points_unref")]
	[Compact]
	...
	[CCode (cheader_filename = "GooCanvas-2.0.h", type_id = "goo_canvas_widget_accessible_factory_get_type ()")]
	...
	[CCode (cheader_filename = "GooCanvas-2.0.h", cprefix = "CAIRO_ANTIALIAS_", type_id = "goo_cairo_antialias_get_type ()")]
	...
	[CCode (cheader_filename = "GooCanvas-2.0.h", cprefix = "CAIRO_FILL_RULE_", type_id = "goo_cairo_fill_rule_get_type ()")]
	public enum CairoFillRule {
		WINDING,
		EVEN_ODD
	}
	[CCode (cheader_filename = "GooCanvas-2.0.h", cprefix = "CAIRO_HINT_METRICS_", type_id = "goo_cairo_hint_metrics_get_type ()")]
	public enum CairoHintMetrics {
		DEFAULT,
		OFF,
		ON
	}
	[CCode (cheader_filename = "GooCanvas-2.0.h", cprefix = "CAIRO_LINE_CAP_", type_id = "goo_cairo_line_cap_get_type ()")]
	public enum CairoLineCap {
		BUTT,
		ROUND,
		SQUARE
	}
	[CCode (cheader_filename = "GooCanvas-2.0.h", cprefix = "CAIRO_LINE_JOIN_", type_id = "goo_cairo_line_join_get_type ()")]
	public enum CairoLineJoin {
		MITER,
		ROUND,
		BEVEL
	}
	[CCode (cheader_filename = "GooCanvas-2.0.h", cprefix = "CAIRO_OPERATOR_", type_id = "goo_cairo_operator_get_type ()")]
	...
	[CCode (cheader_filename = "GooCanvas-2.0.h", cprefix = "GOO_CANVAS_ANCHOR_", type_id = "goo_canvas_anchor_type_get_type ()")]
	...
	[CCode (cheader_filename = "GooCanvas-2.0.h", cprefix = "GOO_CANVAS_ANIMATE_", type_id = "goo_canvas_animate_type_get_type ()")]
	...
	[CCode (cheader_filename = "GooCanvas-2.0.h", cprefix = "GOO_CANVAS_ITEM_", type_id = "goo_canvas_item_visibility_get_type ()")]
	...
	[CCode (cheader_filename = "GooCanvas-2.0.h", cprefix = "GOO_CANVAS_PATH_", type_id = "goo_canvas_path_command_type_get_type ()")]
	...
	[CCode (cheader_filename = "GooCanvas-2.0.h", cprefix = "GOO_CANVAS_EVENTS_", type_id = "goo_canvas_pointer_events_get_type ()")]
	[Flags]
