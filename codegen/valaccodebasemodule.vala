...
public abstract class Vala.CCodeBaseModule : CodeGenerator {
	...
	public override void emit (CodeContext context) {
		...
		header_file.header_type = PUB_HEADER;
		internal_header_file = new CCodeFile ();
		internal_header_file.header_type = INT_HEADER;
	...
	public bool add_symbol_declaration (CCodeFile decl_space, Symbol sym, string name) {
		bool in_generated_header = null != CodeContext.get ().header_filename
		                           && (decl_space.header_type != PUB_HEADER && !sym.is_internal_symbol ());
