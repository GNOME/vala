...
public abstract class Vala.CCodeBaseModule : CodeGenerator {
	...
	public override void emit (CodeContext context) {
		...
		header_file.cfile_type = CCodeFileType.PUB_H_FILE;
		internal_header_file = new CCodeFile ();
		internal_header_file.cfile_type = CCodeFileType.INT_H_FILE;
	...
	public bool add_symbol_declaration (CCodeFile decl_space, Symbol sym, string name) {
		bool in_generated_header = CodeContext.get ().header_filename != null
		                           && (decl_space.cfile_type != CCodeFileType.PUB_H_FILE && !sym.is_internal_symbol ());
